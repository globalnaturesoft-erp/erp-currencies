module Erp::Currencies
  class PriceTerm < ApplicationRecord
    ...
    # class const
    USE_FOR_SALES = 'sales'
    USE_FOR_PURCHASES = 'purchases'
    
    # get use for options
    def self.get_use_for_options()
      [
    ...
    def self.dataselect(keyword='')
      ...
      query = query.limit(8).map{|price_term| {value: price_term.id, text: price_term.name} }
    end
    ...
    # currency name
    def currency_name
			currency.present? ? currency.name : ''
		end
  end
end
